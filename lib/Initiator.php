...
class Initiator extends \Controller_Addon {
	...
	function setup_admin(){
		...
		$this->app->status_icon = [
                        "xepan\marketing\Model_Lead"=>['All'=>'fa fa-globe','Active'=>"fa fa-circle xepan-effect-green",'InActive'=>'fa fa-circle xepan-effect-red'],
                        "xepan\marketing\Model_Opportunity"=>['All'=>'fa fa-globe','Open'=>"fa fa-lightbulb-o xepan-effect-yellow",'Converted'=>'fa fa-check xepan-effect-green','Rejected'=>'fa fa-times xepan-effect-red'],
                        "xepan\marketing\Model_Newsletter"=>['All'=>'fa fa-globe','Draft'=>"fa fa-sticky-note-o ",'Submitted'=>'fa fa-check-square-o xepan-effect-blue','Approved'=>'fa fa-thumbs-up xepan-effect-green','Rejected'=>'fa fa-times xepan-effect-red'],
                        "xepan\marketing\Model_SocialPost"=>['All'=>'fa fa-globe','Draft'=>"fa fa-sticky-note-o ",'Submitted'=>'fa fa-check-square-o xepan-effect-blue','Approved'=>'fa fa-thumbs-up xepan-effect-green','Rejected'=>'fa fa-times xepan-effect-red'],
